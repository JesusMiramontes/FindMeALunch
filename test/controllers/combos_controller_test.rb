...
class CombosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create combo" do
    assert_difference('Combo.count') do
      post combos_url, params: { combo: { description: @combo.description, title: @combo.title } }
    end
  ...
  test "should update combo" do
    patch combo_url(@combo), params: { combo: { description: @combo.description, title: @combo.title } }
